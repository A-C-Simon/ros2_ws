...
class Quaternion():
    ...
    def rotationmtx_to_quaternion(self, m):
        # returns [w, x, y, z], normalized. Standard Shepperd's method: the
        # large-rotation branch picks whichever diagonal element is largest
        # to avoid dividing by a near-zero term.
